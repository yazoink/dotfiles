...
stataic const char *upvol = { "/usr/bin/amixer", "set", "Master", "5%+", NULL };
stataic const char *downvol = { "/usr/bin/amixer", "set", "Master", "5%-", NULL };
stataic const char *mutevol = { "/usr/bin/amixer", "set", "Master", "toggle", NULL };
